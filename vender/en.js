export default {
    ...
    torent_nohash_do_four: 'Write to our telegram group: @prisma_group',
    ...
    torrent_error_info_7: 'If the problem persists, write to the Telegram group @prisma_group with the text (Prisma does not connect to TorrServe after all checks, the current address is {ip})',
