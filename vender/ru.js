export default {
    ...
    settings_interface_animation_descr: 'На слабых устройствах не рекомендуется',
    settings_interface_attenuation: 'Затухание',
    settings_interface_attenuation_descr: 'Эффект затухания картинок снизу и сверху',
    settings_interface_scroll: 'Тип навигации',
    settings_interface_view_card: 'Отображение карточек',
    settings_interface_view_card_descr: 'На слабых устройствах не рекомендуется',
    ...
    settings_interface_hide_outside_the_screen: 'Скрыть блоки карточек за пределами экрана',
    ...
    settings_rest_cache_clear: 'Сбросить на сток или частично',
    ...
    settings_rest_cache_images: 'Кэширование изображений',
    settings_rest_cache_images_descr: 'В локальное хранилище',
    ...
    settings_player_next_episode_descr: 'Автоматическое переключение на следующую серию',
    ...
    settings_player_subs_use_descr: 'Включает субтитры после запуска видео',
    settings_player_subs_size: 'Размер',
    settings_player_subs_size_descr: 'Размер субтитров на экране',
    settings_player_subs_stroke_use: 'Использовать контур',
    settings_player_subs_stroke_use_descr: 'Обведение темным контуром для повышения читаемости',
    settings_player_subs_backdrop_use: 'Подложка субтитров',
    settings_player_subs_backdrop_use_descr: 'Подложка для повышения читаемости на фоне', 
    settings_player_quality: 'Качество видео по умолчанию',
    settings_player_quality_descr: 'Выберите качество видео для просмотра',
    ...
    torent_nohash_do_four: 'Telegram: @prisma_atv',
    ...
    torrent_error_info_7: 'Если проблема не устранена, пишите в Telegram-группу @ с текстом (Prisma не может подключается к TorrServe после всех проверок, текущий адрес {ip})',
    ...
    torrent_install_need: 'Необходимо приложение TorrServe',
    torrent_install_text: 'TorrServe – приложение, позволяет просматривать торрент-файлы в онлайн режиме.<br><br>Детальную информацию вы можете найти в Google',
    ...
    about_text: 'Приложение для просмотра фильмов и сериалов. Вся информация используется исключительно в познавательных целях.',
    about_android: 'Приложение для Android вы можете скачать в нашей группе Telegram',
    ...
    title_about: 'Информация о приложении',
    ...
    title_files: 'Файлы',
    title_now_watch: 'В тренде',
    title_latest: 'Недавно добавленное',
    ...
    title_hight_voite: 'Лидирует по рейтингу',
    title_new: 'Новинки',
    ...
    title_last_year: 'Популярное год назад',
    ...
    prisma_movie_descr: 'Следите за новинками на своем смартфоне. <br>Телеграм: <b>@prisma***</b>',
    ...
    player_error_two: 'Видео не найдено. Попробуйте перезапустить.',
    ...
    copy_link: 'Копировать ссылку для скачивания',
